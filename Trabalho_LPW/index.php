        ...
        <table border="1">
            ...
            <?php foreach ($jogos as $jogo): ?>
                <tr>
                    ...
                    <td><?php   if($jogo->getClassificacaoEtaria() == "L"){ echo "Livre"; } 
                                if($jogo->getClassificacaoEtaria() == "14"){ echo "14 anos"; }
                                if($jogo->getClassificacaoEtaria() == "16"){ echo "16 anos";}
                                if($jogo->getClassificacaoEtaria() == "18"){ echo "+18 anos";}?></td>
                    <td><?= $jogo->getGeneros() ?></td>
                    <td><?= $jogo->getModoJogo() ?></td>
                    <td><?php   if($jogo->getPlataforma() == "N"){echo "Nenhum";}
                                if($jogo->getPlataforma() == "W"){echo "Windows";} 
                                if($jogo->getPlataforma() == "L"){echo "Linux";} 
                                if($jogo->getPlataforma() == "X"){echo "Xbox";} 
                                if($jogo->getPlataforma() == "P"){echo "Playstation";} 
                                if($jogo->getPlataforma() == "NS"){echo "Nintendo Switch";} ?></td>
                    <td><?= $jogo->getPreco() ?></td>
